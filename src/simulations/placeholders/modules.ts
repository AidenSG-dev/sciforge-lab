...
export const physicsPendulum: SimulationModule = createPlaceholderModule({
  ...
  grade: "8-10",
  controls: [
    { kind: "slider", id: "length", label: "Pendulum Length", min: 0.5, max: 20, step: 0.1, unit: "m", defaultValue: 10, group: "Setup" },
    { kind: "slider", id: "angle", label: "Maximum Angle", min: 1, max: 60, step: 0.1, unit: "°", defaultValue: 10.8, group: "Setup" },
    { kind: "slider", id: "gravity", label: "Gravitational Acceleration", min: 1, max: 25, step: 0.1, unit: "m/s²", defaultValue: 9.8, group: "Environment" },
    { kind: "slider", id: "speed", label: "Animation Speed", min: 0.25, max: 3, step: 0.25, unit: "×", defaultValue: 1, group: "Environment" },
    { kind: "toggle", id: "damping", label: "Air resistance", defaultValue: false, group: "Environment" },
    { kind: "checkbox", id: "showTrail", label: "Show motion trail", defaultValue: true, group: "Display" },
  ],
  graph: {
...
export const physicsBuoyancy: SimulationModule = createPlaceholderModule({
  ...
  grade: "8-10",
  controls: [
    { kind: "slider", id: "objectDensity", label: "Object Density", min: 100, max: 3000, step: 10, unit: "kg/m³", defaultValue: 700, group: "Object" },
    { kind: "slider", id: "volume", label: "Object Volume", min: 0.001, max: 0.05, step: 0.001, unit: "m³", defaultValue: 0.01, group: "Object" },
    { kind: "select", id: "fluid", label: "Fluid", options: [
      { value: "water", label: "Water" },
      { value: "seawater", label: "Sea water" },
      { value: "oil", label: "Oil" },
      { value: "glycerine", label: "Glycerine" },
    ], defaultValue: "water", group: "Environment" },
    { kind: "toggle", id: "showForces", label: "Show force vectors", defaultValue: true, group: "Display" },
...
export const chemistryStates: SimulationModule = createPlaceholderModule({
  ...
  grade: "6-8",
  controls: [
    { kind: "slider", id: "temperature", label: "Temperature", min: -100, max: 400, step: 1, unit: "°C", defaultValue: 25, group: "Conditions" },
    { kind: "slider", id: "pressure", label: "Pressure", min: 0.1, max: 5, step: 0.1, unit: "atm", defaultValue: 1, group: "Conditions" },
    { kind: "select", id: "substance", label: "Substance", options: [
      { value: "water", label: "Water" },
      { value: "ethanol", label: "Ethanol" },
      { value: "iron", label: "Iron" },
    ], defaultValue: "water", group: "Sample" },
    { kind: "select", id: "state", label: "Force state", options: [
      { value: "auto", label: "Follow conditions" },
      { value: "solid", label: "Solid" },
      { value: "liquid", label: "Liquid" },
      { value: "gas", label: "Gas" },
    ], defaultValue: "auto", group: "Sample" },
    { kind: "checkbox", id: "showParticleSpeed", label: "Show particle speed", defaultValue: true, group: "Display" },
  ],
  graph: {
...
export const chemistryBonding: SimulationModule = createPlaceholderModule({
  ...
  grade: "9-12",
  controls: [
    { kind: "select", id: "atomA", label: "Atom A", options: [
      { value: "H", label: "Hydrogen" },
      { value: "Na", label: "Sodium" },
      { value: "C", label: "Carbon" },
      { value: "O", label: "Oxygen" },
    ], defaultValue: "Na", group: "Atoms" },
    { kind: "select", id: "atomB", label: "Atom B", options: [
      { value: "Cl", label: "Chlorine" },
      { value: "O", label: "Oxygen" },
      { value: "H", label: "Hydrogen" },
      { value: "N", label: "Nitrogen" },
    ], defaultValue: "Cl", group: "Atoms" },
    { kind: "slider", id: "separation", label: "Atomic Separation", min: 0.5, max: 6, step: 0.1, unit: "Å", defaultValue: 2.4, group: "Geometry" },
    { kind: "checkbox", id: "showElectrons", label: "Show electron clouds", defaultValue: true, group: "Display" },
...
export const biologyHeart: SimulationModule = createPlaceholderModule({
  ...
  grade: "8-10",
  controls: [
    { kind: "slider", id: "heartRate", label: "Heart Rate", min: 40, max: 200, step: 1, unit: "bpm", defaultValue: 72, group: "Body state" },
    { kind: "select", id: "activity", label: "Activity", options: [
      { value: "rest", label: "Resting" },
      { value: "walking", label: "Walking" },
      { value: "running", label: "Running" },
    ], defaultValue: "rest", group: "Body state" },
    { kind: "toggle", id: "highlightOxygen", label: "Highlight oxygenation", defaultValue: true, group: "Display" },
    { kind: "checkbox", id: "labels", label: "Show chamber labels", defaultValue: true, group: "Display" },
    { kind: "slider", id: "speed", label: "Playback Speed", min: 0.25, max: 2, step: 0.25, unit: "×", defaultValue: 1, group: "Display" },
  ],
  graph: {
...
export const biologyCell: SimulationModule = createPlaceholderModule({
  ...
  grade: "6-8",
  controls: [
    { kind: "select", id: "cellType", label: "Cell Type", options: [
      { value: "animal", label: "Animal cell" },
      { value: "plant", label: "Plant cell" },
      { value: "bacterial", label: "Bacterial cell" },
    ], defaultValue: "animal", group: "Sample" },
    { kind: "select", id: "focus", label: "Focus Organelle", options: [
    ...
    ], defaultValue: "none", group: "Sample" },
    { kind: "toggle", id: "crossSection", label: "Cross-section view", defaultValue: false, group: "Display" },
    { kind: "checkbox", id: "autoRotate", label: "Auto-rotate", defaultValue: true, group: "Display" },
  ],
  explanation: {
    whatsHappening:
...
export const roboticsCircuit: SimulationModule = createPlaceholderModule({
  ...
  layout: "robotics",
  controls: [
    { kind: "slider", id: "supplyVoltage", label: "Supply Voltage", min: 1.5, max: 12, step: 0.5, unit: "V", defaultValue: 5, group: "Power" },
    { kind: "slider", id: "resistance", label: "Series Resistance", min: 10, max: 1000, step: 10, unit: "Ω", defaultValue: 220, group: "Power" },
    { kind: "toggle", id: "powerOn", label: "Power", defaultValue: false, group: "Power" },
    { kind: "checkbox", id: "showCurrent", label: "Animate current flow", defaultValue: true, group: "Display" },
  ],
  graph: {
  ...
  explanation: {
    ...
    keyConcept:
      "Ohm's law links voltage, current and resistance in any simple resistive circuit.",
    formula: "V = I · R",
  },
});
...
export const roboticsObstacleRobot: SimulationModule = createPlaceholderModule({
  ...
  layout: "robotics",
  controls: [
    { kind: "slider", id: "sensorRange", label: "Sensor Range", min: 5, max: 120, step: 1, unit: "cm", defaultValue: 30, group: "Sensing" },
    { kind: "slider", id: "turnAngle", label: "Turn Angle", min: 10, max: 180, step: 5, unit: "°", defaultValue: 45, group: "Logic" },
    { kind: "slider", id: "motorSpeed", label: "Motor Speed", min: 10, max: 100, step: 5, unit: "%", defaultValue: 60, group: "Logic" },
    { kind: "select", id: "strategy", label: "Avoidance Strategy", options: [
    ...
    ], defaultValue: "turn-away", group: "Logic" },
    { kind: "toggle", id: "showSensorCone", label: "Show sensor cone", defaultValue: true, group: "Display" },
  ],
  graph: {
